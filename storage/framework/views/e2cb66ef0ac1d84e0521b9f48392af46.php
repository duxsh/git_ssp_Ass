...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.authentication-card','data' => ['style' => 'margin-top: -10px']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['style' => 'margin-top: -10px']); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\Asus\Desktop\APIIT\Year_2\SSP\SEM-1\Assignment\sparparts\resources\views/auth/login.blade.php ENDPATH**/ ?>